...
namespace TiValue {
  ...
  public:
    ...
    TiValue::blockchain::UploadRequestEntry store_file_to_network(const std::string& owner, const std::string& AuthorizatingContractId, const TiValue::blockchain::FilePath& file, const std::string& asset_symbol, double price, uint32_t numofcopy, uint32_t numofpiece, uint32_t payterm, double exec_limit) override;
    TiValue::wallet::WalletTransactionEntry get_file_access(const std::string& file_id) override;
    TiValue::wallet::WalletTransactionEntry store_file_piece(const std::string& file_id, const std::string& file_piece_id, const std::string& beneficiary) override;
    TiValue::wallet::WalletTransactionEntry store_reject(const std::string& file_id, const std::string& file_piece_id, const std::string& node_id) override;
    ...
    vector<string> wallet_get_my_store_request() override;
