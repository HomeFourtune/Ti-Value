...
namespace TiValue { namespace api {
  ...
  public:
    ...
    /**
     * fetch all AlpTrxidBalance from block where blocknum of the block lower than block_num or equal to block_num.
     *
     * @param block_num (uint32_t, required)
     *
     * @return vector<alp_trxid_balance>
     */
    virtual std::vector<TiValue::blockchain::AlpTrxidBalance> blockchain_get_alp_account_balance_entry(uint32_t block_num) = 0;
    /**
