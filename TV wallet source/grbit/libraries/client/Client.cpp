...
namespace TiValue {
    namespace client {
        ...
        const string TIV_MESSAGE_MAGIC = "Alp Signed Message:\n";
        ...
        */
        ...
        fc::variant_object version_info()
        {
            ...
            info["alp_revision"] = TiValue::utilities::git_revision_sha;
            info["alp_revision_age"] = fc::get_approximate_relative_time_string(fc::time_point_sec(TiValue::utilities::git_revision_unix_timestamp));
