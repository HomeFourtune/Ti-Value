	...
	namespace lua {
		namespace api {
			...
			*/
			...
			int get_stored_contract_info_by_address(lua_State *L, const char *contract_id, std::shared_ptr<GluaContractInfo> contract_info_ret)
			{
			...
			std::shared_ptr<GluaModuleByteStream> get_bytestream_from_code(lua_State *L, const thinkyoung::blockchain::Code& code)
			{
				return nullptr;
			}
