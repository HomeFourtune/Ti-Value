...
{"Stream", "() => Stream"},
			...
			static int transfer_from_contract_to_public_account(lua_State *L)
            {
				if (lua_gettop(L) < 3)
				{
					thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "transfer_from_contract_to_public_account need 3 arguments");
					return 0;
				}
				const char *contract_id = get_contract_id_in_api(L);
				if (nullptr == contract_id)
				{
					thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "contract transfer must be called in contract api");
					return 0;
				}
				...
				if (amount_str <= 0)
				{
					thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "amount must be positive");
					return 0;
				}
				lua_Integer transfer_result = thinkyoung::lua::api::transfer_from_contract_to_public_account(L, contract_id, to_account_name, asset_type, amount_str);
            ...
            static int transfer_from_contract_to_address(lua_State *L)
            {
                if (lua_gettop(L) < 3)
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "transfer_from_contract_to_address need 3 arguments");
                    return 0;
                }
                const char *contract_id = get_contract_id_in_api(L);
                if (!contract_id)
                ...
                lua_Integer transfer_result = thinkyoung::lua::api::transfer_from_contract_to_address(L, contract_id, to_address, asset_type, amount_str);
                lua_pushinteger(L, transfer_result);
                return 1;
            }
            ...
            static int get_contract_address_lua_api(lua_State *L)
            {
                ...
                if (!cur_contract_id)
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "can't get current contract address");
                    return 0;
                }
            ...
            static int get_contract_balance_amount(lua_State *L)
            {
                ...
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR,
                ...
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "get balance amount need asset symbol");
                    return 0;
                }

                auto assert_symbol = luaL_checkstring(L, 2);
                
                auto result = thinkyoung::lua::api::get_contract_balance_amount(L, contract_address, assert_symbol);
            ...
            static int panic_message(lua_State *L)
            {
                ...
                if (nullptr != msg)
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, msg);
                return 0;
            }

            static int get_chain_now(lua_State *L)
            {
                auto time = thinkyoung::lua::api::get_chain_now(L);
            ...
            {
                auto rand = thinkyoung::lua::api::get_chain_random(L);
                lua_pushinteger(L, rand);
                return 1;
            }
            static int get_transaction_id(lua_State *L)
            {
                std::string tid = thinkyoung::lua::api::get_transaction_id(L);
                lua_pushstring(L, tid.c_str());
                return 1;
            }
            static int get_transaction_fee(lua_State *L)
            {
                int64_t res = thinkyoung::lua::api::get_transaction_fee(L);
                lua_pushinteger(L, res);
                return 1;
            }
            static int get_header_block_num(lua_State *L)
            {
                auto result = thinkyoung::lua::api::get_header_block_num(L);
                lua_pushinteger(L, result);
                return 1;
            }
            ...
            static int wait_for_future_random(lua_State *L)
            {
                ...
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "wait_for_future_random need a integer param");
                    return 0;
                }
                auto next = luaL_checkinteger(L, 1);
                if (next <= 0)
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "wait_for_future_random first param must be positive number");
                    return 0;
                }
                auto result = thinkyoung::lua::api::wait_for_future_random(L, (int)next);
                lua_pushinteger(L, result);
                return 1;
            }
            ...
            static int get_waited_block_random(lua_State *L)
            {
                if (lua_gettop(L) < 1 || !lua_isinteger(L, 1))
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "get_waited need a integer param");
                    return 0;
                }
                auto num = luaL_checkinteger(L, 1);
                auto result = thinkyoung::lua::api::get_waited(L, (uint32_t)num);
                lua_pushinteger(L, result);
                return 1;
            }
            ...
            static int emit_thinkyoung_event(lua_State *L)
            {
                ...
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "emit need 2 string params");
                    return 0;
                }
                const char *contract_id = get_contract_id_in_api(L);
				...
				if (!contract_id || strlen(contract_id) < 1)
					return 0;
                thinkyoung::lua::api::emit(L, contract_id, event_name, event_param);
                return 0;
            }
			...
			static int glua_core_lib_Stream_size(lua_State *L)
            {
				...
				if(thinkyoung::lua::api::is_object_in_pool(L, (intptr_t) stream,
			...
			static int glua_core_lib_Stream(lua_State *L)
            {
				...
				thinkyoung::lua::api::register_object_in_pool(L, (intptr_t) stream, GluaOutsideObjectTypes::OUTSIDE_STREAM_STORAGE_TYPE);
			...
			*/
			static int glua_core_lib_contract_metatable_newindex(lua_State *L)
			{
				...
				if(key == "id" || key == "name" || key == "storage")
				{
					...
					thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "attempt to update a read-only table!");
			...
			static int glua_core_lib_storage_metatable_index(lua_State *L)
            {
				if(!lua_isstring(L, 2))
				{
					thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "only string can be storage key");
    ...
    return function()  
        ...
        return hashes[i-int_key_size], t[hashes[i-int_key_size]] 
			...
			*/
            ...
            {
                if (!thinkyoung::lua::api::has_exception(L))
                {
            ...
            void close_lua_state(lua_State *L)
            {
				...
				thinkyoung::lua::api::release_objects_in_pool(L);
                LStatesMap *states_map = get_lua_states_value_hashmap();
...
#define MYK(x)		(-1-(x))
	...
	storage: S
				...
				bool throw_exception, bool in_repl, bool is_contract)
            {
				...
				if (use_type_check)
				{
					...
					if(is_contract)
					{
						...
						{
							if(!thinkyoung::lua::api::check_contract_exist(L, p.first.c_str()))
							{
					...
					if (!check_syntax_has_errors || type_checker.has_error() || has_contract_import_error)
					{
						for (const auto & item : type_checker.errors())
							ss << item.second << "\n";
						if(throw_exception)
							thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_COMPILE_ERROR, ss.str().c_str());
					...
					if(stream)
					{
						...
						if(is_contract && contract_storage_type)
						{
							...
							{
								if (throw_exception)
									thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_COMPILE_ERROR, e.what());
								if (error && throw_exception)
								{
				...
				{
					thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_PARSER_ERROR, e.what());
					if (changed)
						*changed = false;
					return origin_code;
				}
					...
					if(is_importing_contract)
					{
						...
						if(getOpMode(o) == OP_LOADK)
						{
							...
							if (idx_in_kst >= 0 && idx_in_kst < proto->sizek)
							{
								...
								if (contract_name && !thinkyoung::lua::api::check_contract_exist(L, contract_name))
								{
					...
					else if(is_importing_contract_address)
					{
						...
						if (getOpMode(o) == OP_LOADK)
						{
							...
							if (idx_in_kst >= 0 && idx_in_kst < proto->sizek)
							{
								...
								if (contract_address && !thinkyoung::lua::api::check_contract_exist_by_address(L, contract_address))
								{
                ...
                char *error, GluaStatePreProcessorFunction *preprocessor, bool use_type_check)
            {
                ...
                if (thinkyoung::lua::api::has_exception(L))
                    thinkyoung::lua::api::clear_exceptions(L);
                ...
                if (!compilefile_to_stream(L, filename, stream, error, use_type_check, true))
                {
                    if (error && strlen(error) > 0)
                    {
                        ...
                        thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_COMPILE_ERROR, error);
                    }
                    else
                        thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_COMPILE_ERROR, "compile error");
                    return false;
                }
                if (thinkyoung::lua::api::has_exception(L))
                    thinkyoung::lua::api::clear_exceptions(L);
                ...
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_COMPILE_ERROR, "compile error when check contract bytecode");
                    return false;
                }
                ...
                if (!lua_istable(L, -1))
                {
                    ...
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, error_str);
                    return false;
                }
                else
                {
				...
				const char *api_name, const char *arg1, std::string *result_json_string)
            {
                ...
                thinkyoung::lua::api::get_contract_address_by_name(L, contract_name, contract_address, &address_size);
                if (address_size > 0)
                {
                    GluaStateValue value;
            ...
            */
            const char *get_contract_id_in_api(lua_State *L)
            {
                ...
                {
                    thinkyoung::lua::api::throw_exception(L, THINKYOUNG_API_SIMPLE_ERROR, "the api must have first local self, or need be defined as <M>:<api_name>");
                }
                lua_pop(L, 1);
                return nullptr;
				*/
