...
FC_REFLECT_ENUM(TiValue::blockchain::TransactionType,
    ...
    FC_REFLECT(TiValue::blockchain::AlpTrxidBalance, (alp_account)(trx_id)(asset_trx)(block_num)(from_account)(create_time))
    FC_REFLECT(TiValue::blockchain::AlpBalanceEntry, (alp_trxid_sort)(alp_block_sort))
    FC_REFLECT(TiValue::blockchain::Transaction, (expiration)(reserved)(alp_account)(alp_inport_asset)(operations)(result_trx_type)(result_trx_id))
